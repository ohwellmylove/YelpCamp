...
mongoose.connect('mongodb+srv://ohwellmylove:michael98@yelp-cluster.c5l8u.mongodb.net/myFirstDatabase?retryWrites=true&w=majority');
...
const seedDB = async () => {
	...
	for (let i = 0; i < 500; i++) {
		...
		const camp = new Campground({
			author: '61f877fca0ba6c57459165f3',
